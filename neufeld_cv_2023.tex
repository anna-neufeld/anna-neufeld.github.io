...
\begin{itemize}
%\item Wu group meeting, Fred Hutch Cancer Research Center, department of ????, April 2023. 
...
%%% Anna to do = Add Mike Wu Lab if it feels like a real thing. Add mom's lab but need to ask if she has a name. Add Amazon Causual Science if it feels like a real thing. 
\end{itemize}
...
%\begin{tabular}{l l l}
%2022 & WNAR Student Paper Award & \emph{WNAR}  
%\end{tabular}  \\
\textbf{University of Washington} \\
\begin{tabular}{l l l}
2022 & Z.W. Birnbaum Award (for best general exam) & \emph{Department of Statistics} \\
%2021 & Nominated for UW-wide Excellence in Teaching Award & \emph{Center for Teaching and Learning} \\
